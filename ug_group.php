...
$nonAdminTablesArr[] = "q_info_compromisos";
$nonAdminTablesArr[] = "q_ctrl_entregainformes_004";
$nonAdminTablesArr[] = "send_mail_supervisores";
$nonAdminTablesArr[] = "send_mail_actaliq";
$nonAdminTablesArr[] = "q_ctrl_entrega_acta_liquidacion_002";
$nonAdminTablesArr[] = "q_ctrl_entrega_acta_liquidacion_001";
$nonAdminTablesArr[] = "tparam_numsup";
$nonAdminTablesArr[] = "tparam_estados";
$nonAdminTablesArr[] = "002_producto";
$nonAdminTablesArr[] = "contractor_master_q";
$nonAdminTablesArr[] = "contrato_planilla_liq";
$nonAdminTablesArr[] = "tparam_administradora";
$nonAdminTablesArr[] = "tparam_administradora_spa";
...
$wGroupTableName = $ug_connection->addTableWrappers( "gestioncontratos_uggroups" );
...
switch(postvalue("a"))
{
	...
	case "del":
		...
		$sql = "delete from ". $ug_connection->addTableWrappers( "gestioncontratos_ugrights" ) 
	...
	case 'saveRights':
		...
		{	
			...
			$wRightsTableName = $ug_connection->addTableWrappers( "gestioncontratos_ugrights" );
