...
require_once("include/contrato_planilla_liq_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "contrato_planilla_liq" );
