...
require_once("include/q_ctrl_entrega_acta_liquidacion_002_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "q_ctrl_entrega_acta_liquidacion_002" );
