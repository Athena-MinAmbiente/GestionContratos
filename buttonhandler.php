...
if($buttId=='BtnInformeSup')
{
	...
	buttonHandler_BtnInformeSup($params);
}
if($buttId=='BtnCRS')
{
	//  for login page users table can be turned off
...
if($buttId=='BtnReload')
{
	...
	buttonHandler_BtnReload($params);
}
if($buttId=='GenPass')
{
	//  for login page users table can be turned off
...
if($buttId=='BtnHome')
{
	...
	buttonHandler_BtnHome($params);
}
if($buttId=='EnviarCorreo')
{
	//  for login page users table can be turned off
	if( $table != GLOBAL_PAGES )
	{
	...
	buttonHandler_EnviarCorreo($params);
}
if($buttId=='BtnSendMailActasLiq')
{
	//  for login page users table can be turned off
	if( $table != GLOBAL_PAGES )
	{
	...
	buttonHandler_BtnSendMailActasLiq($params);
}
...
if( $eventId == 'contractor_nombresfull_event' && "contractor_master_q" == $table )
{
	require_once("include/contractor_master_q_variables.php");
	$cipherer = new RunnerCipherer("contractor_master_q");
	fieldEventHandler_contractor_nombresfull_event( $params );
}
...
function buttonHandler_BtnInformeSup($params)
{
	global $strTableName;
	$result = array();
...
function buttonHandler_BtnReload($params)
{
	global $strTableName;
	$result = array();
...
function buttonHandler_GenPass($params)
{
	global $strTableName;
	$result = array();
...
function buttonHandler_BtnHome($params)
{
	global $strTableName;
	$result = array();
...
function buttonHandler_EnviarCorreo($params)
{
	global $strTableName;
	$result = array();
...
function buttonHandler_BtnSendMailActasLiq($params)
{
	global $strTableName;
	$result = array();
