...
class ConnectionManager_Base
{
	...
	protected function _setTablesConnectionIds()
	{
		...
		$connectionsIds["q_info_compromisos"] = "dbsep_at_127_0_0_1";
		$connectionsIds["q_ctrl_entregainformes_004"] = "dbct_at_localhost";
		$connectionsIds["send_mail_supervisores"] = "dbct_at_localhost";
		$connectionsIds["send_mail_actaliq"] = "dbct_at_localhost";
		$connectionsIds["q_ctrl_entrega_acta_liquidacion_002"] = "dbct_at_localhost";
		$connectionsIds["q_ctrl_entrega_acta_liquidacion_001"] = "dbct_at_localhost";
		$connectionsIds["tparam_numsup"] = "dbct_at_localhost";
		$connectionsIds["tparam_estados"] = "edl_at_localhost";
		$connectionsIds["002_producto"] = "dbsep_at_127_0_0_1";
		$connectionsIds["contractor_master_q"] = "dbct_at_localhost";
		$connectionsIds["contrato_planilla_liq"] = "dbct_at_localhost";
		$connectionsIds["tparam_administradora"] = "dbct_at_localhost";
		$connectionsIds["tparam_administradora_spa"] = "dbct_at_localhost";
