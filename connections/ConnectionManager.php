...
;
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "dbgpaa_at_172_18_0_249";
		$data["connName"] = "dbgpaa at 127.0.0.1";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;127.0.0.1;root;1qaz2wsx;3307;dbgpaa;;1"; //currently unused

		$this->_connectionsIdByName["dbgpaa at 127.0.0.1"] = "dbgpaa_at_172_18_0_249";
...
;
		...
		$connectionsData["dbgpaa_at_172_18_0_249"] = $data;
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "dbsep_at_127_0_0_1";
		$data["connName"] = "dbsep at 127.0.0.1";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;127.0.0.1;root;1qaz2wsx;3307;dbsep;;1"; //currently unused

		$this->_connectionsIdByName["dbsep at 127.0.0.1"] = "dbsep_at_127_0_0_1";
...
;
		...
		$connectionsData["dbsep_at_127_0_0_1"] = $data;
