...
class tDAL
{
	...
	var $tbldbct_at_localhost__contrato_planilla_liq;
	...
	var $tbldbct_at_localhost__gestioncontratos_audit;
	var $tbldbct_at_localhost__gestioncontratos_locking;
	...
	var $tbldbct_at_localhost__q_ctrl_entrega_acta_liquidacion_001;
	var $tbldbct_at_localhost__q_ctrl_entrega_acta_liquidacion_002;
	var $tbldbct_at_localhost__q_ctrl_entregainformes_004;
	...
	var $tbldbct_at_localhost__send_mail_supervisores;
	...
	var $tbldbct_at_localhost__tparam_administradora;
	var $tbldbct_at_localhost__tparam_administradora_spa;
	var $tbldbct_at_localhost__tparam_habilita;
	var $tbldbct_at_localhost__tparam_numsup;
	...
	var $tbldbusers_at_localhost__gestioncontratos_uggroups;
	var $tbldbusers_at_localhost__gestioncontratos_ugmembers;
	var $tbldbusers_at_localhost__gestioncontratos_ugrights;
	...
	var $tbldbsep_at_127_0_0_1__q_info_compromisos;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		...
		$this->lstTables[] = array("name" => "contrato_planilla_liq", "varname" => "dbct_at_localhost__contrato_planilla_liq", "altvarname" => "contrato_planilla_liq", "connId" => "dbct_at_localhost", "schema" => "", "connName" => "dbct at 127.0.0.1");
		...
		$this->lstTables[] = array("name" => "gestioncontratos_audit", "varname" => "dbct_at_localhost__gestioncontratos_audit", "altvarname" => "gestioncontratos_audit", "connId" => "dbct_at_localhost", "schema" => "", "connName" => "dbct at 127.0.0.1");
		$this->lstTables[] = array("name" => "gestioncontratos_locking", "varname" => "dbct_at_localhost__gestioncontratos_locking", "altvarname" => "gestioncontratos_locking", "connId" => "dbct_at_localhost", "schema" => "", "connName" => "dbct at 127.0.0.1");
		...
		$this->lstTables[] = array("name" => "q_ctrl_entrega_acta_liquidacion_001", "varname" => "dbct_at_localhost__q_ctrl_entrega_acta_liquidacion_001", "altvarname" => "q_ctrl_entrega_acta_liquidacion_001", "connId" => "dbct_at_localhost", "schema" => "", "connName" => "dbct at 127.0.0.1");
		$this->lstTables[] = array("name" => "q_ctrl_entrega_acta_liquidacion_002", "varname" => "dbct_at_localhost__q_ctrl_entrega_acta_liquidacion_002", "altvarname" => "q_ctrl_entrega_acta_liquidacion_002", "connId" => "dbct_at_localhost", "schema" => "", "connName" => "dbct at 127.0.0.1");
		$this->lstTables[] = array("name" => "q_ctrl_entregainformes_004", "varname" => "dbct_at_localhost__q_ctrl_entregainformes_004", "altvarname" => "q_ctrl_entregainformes_004", "connId" => "dbct_at_localhost", "schema" => "", "connName" => "dbct at 127.0.0.1");
		...
		$this->lstTables[] = array("name" => "send_mail_supervisores", "varname" => "dbct_at_localhost__send_mail_supervisores", "altvarname" => "send_mail_supervisores", "connId" => "dbct_at_localhost", "schema" => "", "connName" => "dbct at 127.0.0.1");
		...
		$this->lstTables[] = array("name" => "tparam_administradora", "varname" => "dbct_at_localhost__tparam_administradora", "altvarname" => "tparam_administradora", "connId" => "dbct_at_localhost", "schema" => "", "connName" => "dbct at 127.0.0.1");
		$this->lstTables[] = array("name" => "tparam_administradora_spa", "varname" => "dbct_at_localhost__tparam_administradora_spa", "altvarname" => "tparam_administradora_spa", "connId" => "dbct_at_localhost", "schema" => "", "connName" => "dbct at 127.0.0.1");
		...
		$this->lstTables[] = array("name" => "tparam_numsup", "varname" => "dbct_at_localhost__tparam_numsup", "altvarname" => "tparam_numsup", "connId" => "dbct_at_localhost", "schema" => "", "connName" => "dbct at 127.0.0.1");
		...
		$this->lstTables[] = array("name" => "gestioncontratos_uggroups", "varname" => "dbusers_at_localhost__gestioncontratos_uggroups", "altvarname" => "gestioncontratos_uggroups", "connId" => "dbusers_at_localhost", "schema" => "", "connName" => "dbusers at 127.0.0.1");
		$this->lstTables[] = array("name" => "gestioncontratos_ugmembers", "varname" => "dbusers_at_localhost__gestioncontratos_ugmembers", "altvarname" => "gestioncontratos_ugmembers", "connId" => "dbusers_at_localhost", "schema" => "", "connName" => "dbusers at 127.0.0.1");
		$this->lstTables[] = array("name" => "gestioncontratos_ugrights", "varname" => "dbusers_at_localhost__gestioncontratos_ugrights", "altvarname" => "gestioncontratos_ugrights", "connId" => "dbusers_at_localhost", "schema" => "", "connName" => "dbusers at 127.0.0.1");
		...
		$this->lstTables[] = array("name" => "q_info_compromisos", "varname" => "dbsep_at_127_0_0_1__q_info_compromisos", "altvarname" => "q_info_compromisos", "connId" => "dbsep_at_127_0_0_1", "schema" => "", "connName" => "dbsep at 127.0.0.1");
	}
