<?php
	...
	$menuNode["href"] = "mypage.htm";
	$menuNode["type"] = "Leaf";
	$menuNode["table"] = "q_ctrl_entrega_acta_liquidacion_002";
	$menuNode["style"] = "";
	$menuNode["params"] = "";
	$menuNode["parent"] = "47";
	$menuNode["nameType"] = "Text";
	...
	$menuNode["title"] = "Notificaciones | Actas de liquidación";
	...
	$menuNode = array();
	$menuNode["id"] = "50";
	$menuNode["name"] = "Notificaciones | Informes de supervisión";
	$menuNode["href"] = "mypage.htm";
	$menuNode["type"] = "Leaf";
	$menuNode["table"] = "q_ctrl_entregainformes_004";
	$menuNode["style"] = "";
	$menuNode["params"] = "";
	$menuNode["parent"] = "47";
	$menuNode["nameType"] = "Text";
	...
	$menuNode["title"] = "Notificaciones | Informes de supervisión";
