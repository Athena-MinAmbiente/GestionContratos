...
$custom_labels["Spanish"] = array();
	$custom_labels["Spanish"]['ADD_NEW'] = "Vincular supervisor";
	$custom_labels["Spanish"]['ADD_NEW1'] = "Registrar nuevo contrato";
...
$globalSettings["strSMTPUser"] = "notificaciones@jcc.gov.co";
$globalSettings["strSMTPServer"] = "smtp.office365.com";
$globalSettings["strSMTPPort"] = "587";
$globalSettings["strSMTPPassword"] = "w%^u9Qcd!!36";
$globalSettings["strFromEmail"] = "notificaciones@jcc.gov.co";
...
$projectBuildKey = "1786_1713493921";
...
$tableCaptions["Spanish"]["global_users"] = "Buscar usuarios";
$tableCaptions["Spanish"]["contrato"] = "Contrato";
$tableCaptions["Spanish"]["contractor_master"] = "Información del contratista";
...
$tableCaptions["Spanish"]["contractor_master_vinc"] = "Contractor Master Vinc";
...
$tableCaptions["Spanish"]["tparam_tipo_ct_000"] = "Tparam Tipo Ct 000";
$tableCaptions["Spanish"]["tparam_tipo_ct_001"] = "Tparam Tipo Ct 001";
$tableCaptions["Spanish"]["tparam_tipo_ct_002"] = "Tparam Tipo Ct 002";
$tableCaptions["Spanish"]["tipo_contrato"] = "Tipo Contrato";
$tableCaptions["Spanish"]["contrato_forma_pago"] = "Contrato Forma Pago";
$tableCaptions["Spanish"]["tipo_si_no"] = "Tipo Si No";
$tableCaptions["Spanish"]["contrato_estados"] = "Contrato Estados";
$tableCaptions["Spanish"]["contrato_pre"] = "Pre - Número";
...
$tableCaptions["Spanish"]["interventor_interno"] = "Supervisión";
$tableCaptions["Spanish"]["tparam_habilita"] = "Tparam Habilita";
$tableCaptions["Spanish"]["contrato_cdp"] = "CDP";
$tableCaptions["Spanish"]["dependencia"] = "Dependencia";
$tableCaptions["Spanish"]["contrato_rp"] = "Registro presupuestal | Compromiso";
$tableCaptions["Spanish"]["dependencias_001"] = "Dependencias 001";
$tableCaptions["Spanish"]["tparam_tipo_ct_regimen_tribut"] = "Tparam Tipo Ct Regimen Tribut";
$tableCaptions["Spanish"]["cargo"] = "Cargo";
$tableCaptions["Spanish"]["tparam_sn"] = "Tparam Sn";
$tableCaptions["Spanish"]["informe_intersup_plan_pagos"] = "Prog. Entrega de informes y pagos";
$tableCaptions["Spanish"]["q_001_dashboard"] = "Informe";
...
$tableCaptions["Spanish"]["q_bandejaentrada_supervisores"] = "Supervisión";
...
$tableCaptions["Spanish"]["contrato_modifica_track"] = "Histórico de cambios";
...
$tableCaptions["Spanish"]["global_users_sup"] = "Consulta de supervisores";
$tableCaptions["Spanish"]["informe_intersup4"] = "Informes de supervisión";
$tableCaptions["Spanish"]["nomina_cont_meses"] = "Nomina Cont Meses";
$tableCaptions["Spanish"]["informe_intersup_anexos_supervisor"] = ".: | ";
$tableCaptions["Spanish"]["informe_intersup_oe_borrar"] = "Informe Intersup Oe Borrar";
$tableCaptions["Spanish"]["informe_intersup_oe_supervisor"] = "Revisión de obligaciones específicas";
$tableCaptions["Spanish"]["informe_intersup2"] = "Informe Intersup2";
$tableCaptions["Spanish"]["informe_intersup2r"] = "Informe Intersup2r";
$tableCaptions["Spanish"]["q_gestion_infosup_pagos"] = "Q Gestion Infosup Pagos";
$tableCaptions["Spanish"]["informe_intersup_adm"] = "Informe Intersup Adm";
$tableCaptions["Spanish"]["informe_intersup_cxc_adm"] = "Solicitud de pago";
$tableCaptions["Spanish"]["informe_intersup_oe_adm"] = "Obligaciones específicas";
$tableCaptions["Spanish"]["informe_intersup_anexos_adm"] = "Anexos al informe";
$tableCaptions["Spanish"]["informe_intersup_plan_pagos_adm"] = "Plan de pagos";
$tableCaptions["Spanish"]["q_consulta_op"] = "Pagos";
$tableCaptions["Spanish"]["q_global_supervisores_activos_group"] = "Q Global Supervisores Activos Group";
$tableCaptions["Spanish"]["q_bandejaentrada_supervisores_consulta"] = "Q Bandejaentrada Supervisores Consulta";
$tableCaptions["Spanish"]["contrato_ov"] = "Contrato histórico";
$tableCaptions["Spanish"]["contrato_attached_ov"] = "Gestión de documentos";
$tableCaptions["Spanish"]["q_s_ctrl_pagado_001"] = "Q S Ctrl Pagado 001";
$tableCaptions["Spanish"]["q_s_ctrl_pagado_001_Report"] = "Tabla dinámica";
$tableCaptions["Spanish"]["contrato_audit"] = "Auditar contratos";
$tableCaptions["Spanish"]["contrato_paa"] = "PAA (Secop)";
$tableCaptions["Spanish"]["q_informe_secop_publicados_dbgpaa"] = "Publicados en SECOP";
$tableCaptions["Spanish"]["global_duracion"] = "Global Duracion";
$tableCaptions["Spanish"]["contrato_modifica_suspension"] = "Suspensión";
$tableCaptions["Spanish"]["tparam_tipopago"] = "Tparam Tipopago";
$tableCaptions["Spanish"]["q_001_dashboard_master"] = "Q 001 Dashboard Master";
$tableCaptions["Spanish"]["consulta_producto"] = "Consulta Producto";
$tableCaptions["Spanish"]["consulta_catalogo"] = "Consulta Catalogo";
...
$tableCaptions["Spanish"]["q_info_compromisos"] = "Compromisos | RP";
$tableCaptions["Spanish"]["q_ctrl_entregainformes_004"] = "Q Ctrl Entregainformes 004";
$tableCaptions["Spanish"]["send_mail_supervisores"] = "Send Mail Supervisores";
$tableCaptions["Spanish"]["send_mail_actaliq"] = "Send Mail Actaliq";
$tableCaptions["Spanish"]["q_ctrl_entrega_acta_liquidacion_002"] = "Notificaciones | Actas de liquidación";
$tableCaptions["Spanish"]["q_ctrl_entrega_acta_liquidacion_001"] = "Detalle | Actas de liquidación";
$tableCaptions["Spanish"]["tparam_numsup"] = "Tparam Numsup";
$tableCaptions["Spanish"]["tparam_estados"] = "Tparam Estados";
$tableCaptions["Spanish"]["002_producto"] = "002 Producto";
$tableCaptions["Spanish"]["contractor_master_q"] = "Contractor Master Q";
$tableCaptions["Spanish"]["contrato_planilla_liq"] = "Planilla integrada";
$tableCaptions["Spanish"]["tparam_administradora"] = "Tparam Administradora";
$tableCaptions["Spanish"]["tparam_administradora_spa"] = "Tparam Administradora Spa";
...
if(mlang_getcurrentlang()=="Spanish")
{
	...
	$page_titles[GLOBAL_PAGES_SHORT]["Spanish"]["login"] = "CONTRATOS";
}
...
$_SESSION['build'] = $projectBuildNumber; // Build
$ip = $_SERVER['REMOTE_ADDR'];
$_SESSION['user_ip'] = $ip; // ip del usuario

global $conn;
$sql = "
SELECT
	dbusers.global_config.Modulo,
	dbusers.global_config.GEntidad,
	dbusers.global_config.GURL,
	dbusers.global_config.GURLHOME,
	dbusers.global_config.EmailBCC,
	dbusers.global_config.EmailAdmin,
	dbusers.global_config.logo,
	dbusers.global_config.mailserver,
	dbusers.global_config.correosmtp,
	dbusers.global_config.GVersion 
FROM
	dbusers.global_config 
WHERE
	dbusers.global_config.cid = 2
";
$rs = DB::Query($sql);
$datos = $rs->fetchAssoc();
if($datos)
	{
$_SESSION['GModulo'] = $datos["Modulo"]; // Nombre de la entidad
$_SESSION['GEntidad'] = $datos["GEntidad"]; // Nombre de la entidad
$_SESSION['GURL'] = $datos["GURL"]; // URL del módulo
$_SESSION['GURLHOME'] = $datos["GURLHOME"]; // URL del módulo
$_SESSION['EmailBCC'] = $datos["EmailBCC"]; // copia de correo oculto, si se notifica a + de uno se separa con coma
$_SESSION['EmailAdmin'] = $datos["EmailAdmin"];
$_SESSION['logo'] = $datos["logo"]; // URL del logo se usa para el correo electronico en el encabezado
$_SESSION['mailserver'] = $datos["mailserver"];
$_SESSION['correosmtp'] = $datos["correosmtp"];
$_SESSION['GVersion'] = $datos["GVersion"];
}
