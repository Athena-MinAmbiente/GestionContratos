...
$tdatacontrato_forma_pago[".badgeColor"] = "2F4F4F";
...
//	contrato_audit
	...
	$detailsTablesData["contrato_forma_pago"][$dIndex] = $detailsParam;

	
		$detailsTablesData["contrato_forma_pago"][$dIndex]["masterKeys"] = array();

	$detailsTablesData["contrato_forma_pago"][$dIndex]["masterKeys"][]="codigo";

				$detailsTablesData["contrato_forma_pago"][$dIndex]["detailKeys"] = array();

	$detailsTablesData["contrato_forma_pago"][$dIndex]["detailKeys"][]="cont_formapago";
//endif
