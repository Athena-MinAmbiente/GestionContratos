...
$tdataq_000_control_informes[".pagesByType"] = my_json_decode( "{\"list\":[\"list\"],\"search\":[\"search\"]}" );
$tdataq_000_control_informes[".originalPagesByType"] = $tdataq_000_control_informes[".pagesByType"];
$tdataq_000_control_informes[".pages"] = types2pages( my_json_decode( "{\"list\":[\"list\"],\"search\":[\"search\"]}" ) );
$tdataq_000_control_informes[".originalPages"] = $tdataq_000_control_informes[".pages"];
$tdataq_000_control_informes[".defaultPages"] = my_json_decode( "{\"list\":\"list\",\"search\":\"search\"}" );
