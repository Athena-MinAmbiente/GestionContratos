...
function checkTableName($shortTName )
{
	...
	if ("divipola" == $shortTName )
		return true;
	if ("contractor_master_vinc" == $shortTName )
		return true;
	...
	if ("tparam_tipo_ct_002" == $shortTName )
		return true;
	if ("tipo_contrato" == $shortTName )
		return true;
	if ("contrato_forma_pago" == $shortTName )
		return true;
	if ("tipo_si_no" == $shortTName )
		return true;
	if ("contrato_estados" == $shortTName )
		return true;
	if ("contrato_pre" == $shortTName )
		return true;
	if ("contrato_attached" == $shortTName )
		return true;
	if ("contrato_attached_type" == $shortTName )
		return true;
	if ("polizas_master" == $shortTName )
		return true;
	if ("polizas_tipo" == $shortTName )
		return true;
	if ("polizas_aseguradoras" == $shortTName )
		return true;
	if ("info_secop" == $shortTName )
		return true;
	if ("interventor_interno" == $shortTName )
		return true;
	if ("tparam_habilita" == $shortTName )
		return true;
	if ("contrato_cdp" == $shortTName )
		return true;
	if ("dependencia" == $shortTName )
		return true;
	if ("contrato_rp" == $shortTName )
		return true;
	if ("dependencias_001" == $shortTName )
		return true;
	if ("tparam_tipo_ct_regimen_tribut" == $shortTName )
		return true;
	if ("cargo" == $shortTName )
		return true;
	if ("tparam_sn" == $shortTName )
		return true;
	if ("informe_intersup_plan_pagos" == $shortTName )
		return true;
	if ("q_001_dashboard" == $shortTName )
		return true;
	if ("informe_intersup_estado" == $shortTName )
		return true;
	if ("informe_tipo" == $shortTName )
		return true;
	if ("contrato_chart_tiporubro" == $shortTName )
		return true;
	if ("contrato_chart_estado" == $shortTName )
		return true;
	if ("contrato_chart_tipocont" == $shortTName )
		return true;
	if ("contrato_chart_dependencia" == $shortTName )
		return true;
	if ("contrato_chart_supjer" == $shortTName )
		return true;
	if ("tparam_tipo_ct_rubro" == $shortTName )
		return true;
	if ("q_001_dashboard_info" == $shortTName )
		return true;
	if ("q_bandejaentrada_supervisores" == $shortTName )
		return true;
	if ("q_000_control_informes" == $shortTName )
		return true;
	if ("informe_intersup_plan_pagos_st" == $shortTName )
		return true;
	if ("contrato_oe" == $shortTName )
		return true;
	if ("q_oe_ordinal" == $shortTName )
		return true;
	if ("q_bandejaentrada_supervisores1" == $shortTName )
		return true;
	if ("informe_intersup" == $shortTName )
		return true;
	if ("q_bandejaentrada_supervisores2" == $shortTName )
		return true;
	if ("q_divipola" == $shortTName )
		return true;
	if ("informe_intersup_oe" == $shortTName )
		return true;
	if ("tparam_sn_oe" == $shortTName )
		return true;
	if ("contrato_modifica" == $shortTName )
		return true;
	if ("contrato_modifica_type" == $shortTName )
		return true;
	if ("contrato_modifica_prorroga" == $shortTName )
		return true;
	if ("contrato_modifica_cesion" == $shortTName )
		return true;
	if ("contrato_modifica_track" == $shortTName )
		return true;
	if ("q_bandejaentrada_supervisores3" == $shortTName )
		return true;
	if ("informe_intersup3" == $shortTName )
		return true;
	if ("contrato_dependencia" == $shortTName )
		return true;
	if ("global_users_sup" == $shortTName )
		return true;
	if ("informe_intersup4" == $shortTName )
		return true;
	if ("nomina_cont_meses" == $shortTName )
		return true;
	if ("informe_intersup_anexos_supervisor" == $shortTName )
		return true;
	if ("informe_intersup_oe_borrar" == $shortTName )
		return true;
	if ("informe_intersup_oe_supervisor" == $shortTName )
		return true;
	if ("informe_intersup2" == $shortTName )
		return true;
	if ("informe_intersup2r" == $shortTName )
		return true;
	if ("q_gestion_infosup_pagos" == $shortTName )
		return true;
	if ("informe_intersup_adm" == $shortTName )
		return true;
	if ("informe_intersup_cxc_adm" == $shortTName )
		return true;
	if ("informe_intersup_oe_adm" == $shortTName )
		return true;
	if ("informe_intersup_anexos_adm" == $shortTName )
		return true;
	if ("informe_intersup_plan_pagos_adm" == $shortTName )
		return true;
	if ("q_consulta_op" == $shortTName )
		return true;
	if ("q_global_supervisores_activos_group" == $shortTName )
		return true;
	if ("q_bandejaentrada_supervisores_consulta" == $shortTName )
		return true;
	if ("contrato_ov" == $shortTName )
		return true;
	if ("contrato_attached_ov" == $shortTName )
		return true;
	if ("q_s_ctrl_pagado_001" == $shortTName )
		return true;
	if ("q_s_ctrl_pagado_001_report" == $shortTName )
		return true;
	if ("contrato_audit" == $shortTName )
		return true;
	if ("contrato_paa" == $shortTName )
		return true;
	if ("q_informe_secop_publicados_dbgpaa" == $shortTName )
		return true;
	if ("global_duracion" == $shortTName )
		return true;
	if ("contrato_modifica_suspension" == $shortTName )
		return true;
	if ("tparam_tipopago" == $shortTName )
		return true;
	if ("q_001_dashboard_master" == $shortTName )
		return true;
	if ("consulta_producto" == $shortTName )
		return true;
	if ("consulta_catalogo" == $shortTName )
		return true;
	...
	if ("admin_users" == $shortTName )
		return true;
	if ("q_info_compromisos" == $shortTName )
		return true;
	if ("q_ctrl_entregainformes_004" == $shortTName )
		return true;
	if ("send_mail_supervisores" == $shortTName )
		return true;
	if ("send_mail_actaliq" == $shortTName )
		return true;
	if ("q_ctrl_entrega_acta_liquidacion_002" == $shortTName )
		return true;
	if ("q_ctrl_entrega_acta_liquidacion_001" == $shortTName )
		return true;
	if ("tparam_numsup" == $shortTName )
		return true;
	if ("tparam_estados" == $shortTName )
		return true;
	if ("002_producto" == $shortTName )
		return true;
	if ("contractor_master_q" == $shortTName )
		return true;
	if ("contrato_planilla_liq" == $shortTName )
		return true;
	if ("tparam_administradora" == $shortTName )
		return true;
	if ("tparam_administradora_spa" == $shortTName )
		return true;
	return false;
}
...
function GetTablesList($pdfMode = false)
{
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("contractor_master_vinc");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="contractor_master_vinc";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tipo_contrato");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tipo_si_no");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("contrato_attached");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="contrato_attached";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("polizas_master");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("info_secop");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("interventor_interno");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="interventor_interno";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tparam_habilita");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("contrato_cdp");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("contrato_rp");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("informe_intersup_plan_pagos");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tparam_tipo_ct_rubro");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("q_001_dashboard_info");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("contrato_modifica");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="contrato_modifica";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("contrato_modifica_type");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("contrato_modifica_prorroga");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("contrato_modifica_cesion");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("informe_intersup4");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="informe_intersup4";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("nomina_cont_meses");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="nomina_cont_meses";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("informe_intersup_anexos_supervisor");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="informe_intersup_anexos_supervisor";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("informe_intersup_oe_borrar");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="informe_intersup_oe_borrar";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("informe_intersup_oe_supervisor");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="informe_intersup_oe_supervisor";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("informe_intersup2");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="informe_intersup2";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("informe_intersup2r");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="informe_intersup2r";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("q_gestion_infosup_pagos");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="q_gestion_infosup_pagos";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("informe_intersup_adm");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="informe_intersup_adm";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("informe_intersup_cxc_adm");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="informe_intersup_cxc_adm";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("informe_intersup_oe_adm");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="informe_intersup_oe_adm";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("informe_intersup_anexos_adm");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="informe_intersup_anexos_adm";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("informe_intersup_plan_pagos_adm");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="informe_intersup_plan_pagos_adm";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("q_consulta_op");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("q_global_supervisores_activos_group");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="q_global_supervisores_activos_group";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("q_bandejaentrada_supervisores_consulta");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="q_bandejaentrada_supervisores_consulta";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("contrato_ov");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("contrato_attached_ov");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="contrato_attached_ov";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("q_s_ctrl_pagado_001");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="q_s_ctrl_pagado_001";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("q_s_ctrl_pagado_001 Report");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="q_s_ctrl_pagado_001 Report";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("contrato_audit");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("contrato_paa");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("q_informe_secop_publicados_dbgpaa");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="q_informe_secop_publicados_dbgpaa";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("global_duracion");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("contrato_modifica_suspension");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="contrato_modifica_suspension";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tparam_tipopago");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("q_001_dashboard_master");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="q_001_dashboard_master";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("consulta_producto");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="consulta_producto";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("consulta_catalogo");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="consulta_catalogo";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("q_info_compromisos");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="q_info_compromisos";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("q_ctrl_entregainformes_004");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="q_ctrl_entregainformes_004";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("send_mail_supervisores");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="send_mail_supervisores";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("send_mail_actaliq");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="send_mail_actaliq";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("q_ctrl_entrega_acta_liquidacion_002");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="q_ctrl_entrega_acta_liquidacion_002";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("q_ctrl_entrega_acta_liquidacion_001");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="q_ctrl_entrega_acta_liquidacion_001";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tparam_numsup");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("002_producto");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("contractor_master_q");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="contractor_master_q";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("contrato_planilla_liq");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="contrato_planilla_liq";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tparam_administradora");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="tparam_administradora";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tparam_administradora_spa");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="tparam_administradora_spa";
	}
	return $arr;
}
...
//	default permissions
	...
	if( $table=="informe_intersup_anexos_supervisor" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="informe_intersup_oe_borrar" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
...
//	default permissions
	...
	if( $table=="q_gestion_infosup_pagos" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="informe_intersup_adm" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="informe_intersup_cxc_adm" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="informe_intersup_oe_adm" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="informe_intersup_anexos_adm" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="informe_intersup_plan_pagos_adm" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="q_consulta_op" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="q_global_supervisores_activos_group" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="q_bandejaentrada_supervisores_consulta" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="contrato_ov" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="contrato_attached_ov" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="q_s_ctrl_pagado_001" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="q_s_ctrl_pagado_001 Report" )
	{
//	default permissions
		return "SP".$extraPerm;
	}
	if( $table=="contrato_audit" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="contrato_paa" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="q_informe_secop_publicados_dbgpaa" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="global_duracion" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="contrato_modifica_suspension" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="tparam_tipopago" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="q_001_dashboard_master" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="consulta_producto" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="consulta_catalogo" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
...
//	default permissions
	...
	if( $table=="q_info_compromisos" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="q_ctrl_entregainformes_004" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="send_mail_supervisores" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="send_mail_actaliq" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="q_ctrl_entrega_acta_liquidacion_002" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="q_ctrl_entrega_acta_liquidacion_001" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="tparam_numsup" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
...
//	default permissions
	...
	if( $table=="002_producto" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="contractor_master_q" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="contrato_planilla_liq" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="tparam_administradora" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="tparam_administradora_spa" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
