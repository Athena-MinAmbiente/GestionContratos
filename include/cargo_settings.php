...
$tdatacargo[".pagesByType"] = my_json_decode( "{\"list\":[\"list\"],\"search\":[\"search\"]}" );
$tdatacargo[".originalPagesByType"] = $tdatacargo[".pagesByType"];
$tdatacargo[".pages"] = types2pages( my_json_decode( "{\"list\":[\"list\"],\"search\":[\"search\"]}" ) );
$tdatacargo[".originalPages"] = $tdatacargo[".pages"];
$tdatacargo[".defaultPages"] = my_json_decode( "{\"list\":\"list\",\"search\":\"search\"}" );
