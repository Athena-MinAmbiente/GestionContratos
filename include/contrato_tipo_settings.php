...
$tdatacontrato_tipo[".badgeColor"] = "E67349";
...
//	contrato_audit
	...
	$detailsTablesData["contrato_tipo"][$dIndex] = $detailsParam;

	
		$detailsTablesData["contrato_tipo"][$dIndex]["masterKeys"] = array();

	$detailsTablesData["contrato_tipo"][$dIndex]["masterKeys"][]="codigo";

				$detailsTablesData["contrato_tipo"][$dIndex]["detailKeys"] = array();

	$detailsTablesData["contrato_tipo"][$dIndex]["detailKeys"][]="cont_tipo";
//endif
