...
$tdataglobal_users_sup[".pagesByType"] = my_json_decode( "{\"export\":[\"export\"],\"list\":[\"list\"],\"search\":[\"search\"]}" );
$tdataglobal_users_sup[".originalPagesByType"] = $tdataglobal_users_sup[".pagesByType"];
$tdataglobal_users_sup[".pages"] = types2pages( my_json_decode( "{\"export\":[\"export\"],\"list\":[\"list\"],\"search\":[\"search\"]}" ) );
$tdataglobal_users_sup[".originalPages"] = $tdataglobal_users_sup[".pages"];
$tdataglobal_users_sup[".defaultPages"] = my_json_decode( "{\"export\":\"export\",\"list\":\"list\",\"search\":\"search\"}" );
...
$tdataglobal_users_sup[".sqlHead"] = "SELECT idusrglobal,  id_fk,  Username,  usr_email,  usr_nombresfull,  usr_personalid,  usr_dep,  usr_dep_sup,  usr_cargo,  usr_name,  usr_lname,  global_rol_contratos";
$tdataglobal_users_sup[".sqlFrom"] = "FROM global_users";
$tdataglobal_users_sup[".sqlWhereExpr"] = "(global_rol_contratos = 3)";
...
$proto0["m_strFieldList"] = "idusrglobal,  id_fk,  Username,  usr_email,  usr_nombresfull,  usr_personalid,  usr_dep,  usr_dep_sup,  usr_cargo,  usr_name,  usr_lname,  global_rol_contratos";
$proto0["m_strFrom"] = "FROM global_users";
$proto0["m_strWhere"] = "(global_rol_contratos = 3)";
$proto0["m_strOrderBy"] = "";
	
												;
			$proto0["cipherer"] = null;
$proto2=array();
$proto2["m_sql"] = "global_rol_contratos = 3";
...
$proto28["m_sql"] = "global_rol_contratos";
