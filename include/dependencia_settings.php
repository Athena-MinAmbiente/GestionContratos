...
$tdatadependencia[".pagesByType"] = my_json_decode( "{\"list\":[\"list\"],\"search\":[\"search\"]}" );
$tdatadependencia[".originalPagesByType"] = $tdatadependencia[".pagesByType"];
$tdatadependencia[".pages"] = types2pages( my_json_decode( "{\"list\":[\"list\"],\"search\":[\"search\"]}" ) );
$tdatadependencia[".originalPages"] = $tdatadependencia[".pages"];
$tdatadependencia[".defaultPages"] = my_json_decode( "{\"list\":\"list\",\"search\":\"search\"}" );
...
$tdatadependencia[".badgeColor"] = "5F9EA0";
