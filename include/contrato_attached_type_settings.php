...
$tdatacontrato_attached_type[".pagesByType"] = my_json_decode( "{\"masterlist\":[\"masterlist\"],\"masterprint\":[\"masterprint\"]}" );
$tdatacontrato_attached_type[".originalPagesByType"] = $tdatacontrato_attached_type[".pagesByType"];
$tdatacontrato_attached_type[".pages"] = types2pages( my_json_decode( "{\"masterlist\":[\"masterlist\"],\"masterprint\":[\"masterprint\"]}" ) );
$tdatacontrato_attached_type[".originalPages"] = $tdatacontrato_attached_type[".pages"];
$tdatacontrato_attached_type[".defaultPages"] = my_json_decode( "{\"masterlist\":\"masterlist\",\"masterprint\":\"masterprint\"}" );
...
$tdatacontrato_attached_type[".badgeColor"] = "3CB371";
