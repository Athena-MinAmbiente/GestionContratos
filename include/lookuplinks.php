...
function InitLookupLinks()
{
	...
	$lookupTableLinks = array();
		...
		if( !isset( $lookupTableLinks["contractor_master_q"] ) ) {
			$lookupTableLinks["contractor_master_q"] = array();
		}
		if( !isset( $lookupTableLinks["contractor_master_q"]["contrato.cont_nit_contra_ta"] )) {
			$lookupTableLinks["contractor_master_q"]["contrato.cont_nit_contra_ta"] = array();
		}
		$lookupTableLinks["contractor_master_q"]["contrato.cont_nit_contra_ta"]["edit"] = array("table" => "contrato", "field" => "cont_nit_contra_ta", "page" => "edit");
		...
		if( !isset( $lookupTableLinks["002_producto"]["contrato.cont_codrubro"] )) {
			$lookupTableLinks["002_producto"]["contrato.cont_codrubro"] = array();
		}
		$lookupTableLinks["002_producto"]["contrato.cont_codrubro"]["edit"] = array("table" => "contrato", "field" => "cont_codrubro", "page" => "edit");
		...
		if( !isset( $lookupTableLinks["cargo"]["interventor_interno.cargo_id"] )) {
			$lookupTableLinks["cargo"]["interventor_interno.cargo_id"] = array();
		}
		$lookupTableLinks["cargo"]["interventor_interno.cargo_id"]["edit"] = array("table" => "interventor_interno", "field" => "cargo_id", "page" => "edit");
		if( !isset( $lookupTableLinks["dependencia"] ) ) {
			$lookupTableLinks["dependencia"] = array();
		}
		if( !isset( $lookupTableLinks["dependencia"]["interventor_interno.dependencia_id"] )) {
			$lookupTableLinks["dependencia"]["interventor_interno.dependencia_id"] = array();
		}
		$lookupTableLinks["dependencia"]["interventor_interno.dependencia_id"]["edit"] = array("table" => "interventor_interno", "field" => "dependencia_id", "page" => "edit");
		...
		$lookupTableLinks["tparam_habilita"]["interventor_interno.sup_status"]["add"] = array("table" => "interventor_interno", "field" => "sup_status", "page" => "add");
		if( !isset( $lookupTableLinks["tparam_habilita"] ) ) {
			$lookupTableLinks["tparam_habilita"] = array();
		}
		if( !isset( $lookupTableLinks["tparam_habilita"]["interventor_interno.sup_status"] )) {
		...
		$lookupTableLinks["tparam_habilita"]["interventor_interno.sup_status"]["search"] = array("table" => "interventor_interno", "field" => "sup_status", "page" => "search");
		if( !isset( $lookupTableLinks["tparam_numsup"] ) ) {
			$lookupTableLinks["tparam_numsup"] = array();
		}
		if( !isset( $lookupTableLinks["tparam_numsup"]["interventor_interno.num_sup"] )) {
			$lookupTableLinks["tparam_numsup"]["interventor_interno.num_sup"] = array();
		}
		$lookupTableLinks["tparam_numsup"]["interventor_interno.num_sup"]["edit"] = array("table" => "interventor_interno", "field" => "num_sup", "page" => "edit");
		if( !isset( $lookupTableLinks["cargo"] ) ) {
			$lookupTableLinks["cargo"] = array();
		}
		if( !isset( $lookupTableLinks["cargo"]["interventor_interno.supa_cargo_id"] )) {
			$lookupTableLinks["cargo"]["interventor_interno.supa_cargo_id"] = array();
		}
		$lookupTableLinks["cargo"]["interventor_interno.supa_cargo_id"]["edit"] = array("table" => "interventor_interno", "field" => "supa_cargo_id", "page" => "edit");
		if( !isset( $lookupTableLinks["dependencia"] ) ) {
			$lookupTableLinks["dependencia"] = array();
		}
		if( !isset( $lookupTableLinks["dependencia"]["interventor_interno.supa_dependencia_id"] )) {
			$lookupTableLinks["dependencia"]["interventor_interno.supa_dependencia_id"] = array();
		}
		$lookupTableLinks["dependencia"]["interventor_interno.supa_dependencia_id"]["edit"] = array("table" => "interventor_interno", "field" => "supa_dependencia_id", "page" => "edit");
		if( !isset( $lookupTableLinks["global_users_sup"] ) ) {
			$lookupTableLinks["global_users_sup"] = array();
		}
		if( !isset( $lookupTableLinks["global_users_sup"]["interventor_interno.supa_idusrglobal_fk"] )) {
			$lookupTableLinks["global_users_sup"]["interventor_interno.supa_idusrglobal_fk"] = array();
		}
		$lookupTableLinks["global_users_sup"]["interventor_interno.supa_idusrglobal_fk"]["edit"] = array("table" => "interventor_interno", "field" => "supa_idusrglobal_fk", "page" => "edit");
		if( !isset( $lookupTableLinks["cargo"] ) ) {
			$lookupTableLinks["cargo"] = array();
		}
		if( !isset( $lookupTableLinks["cargo"]["interventor_interno.supb_cargo_id"] )) {
			$lookupTableLinks["cargo"]["interventor_interno.supb_cargo_id"] = array();
		}
		$lookupTableLinks["cargo"]["interventor_interno.supb_cargo_id"]["edit"] = array("table" => "interventor_interno", "field" => "supb_cargo_id", "page" => "edit");
		if( !isset( $lookupTableLinks["dependencia"] ) ) {
			$lookupTableLinks["dependencia"] = array();
		}
		if( !isset( $lookupTableLinks["dependencia"]["interventor_interno.supb_dependencia_id"] )) {
			$lookupTableLinks["dependencia"]["interventor_interno.supb_dependencia_id"] = array();
		}
		$lookupTableLinks["dependencia"]["interventor_interno.supb_dependencia_id"]["edit"] = array("table" => "interventor_interno", "field" => "supb_dependencia_id", "page" => "edit");
		if( !isset( $lookupTableLinks["global_users_sup"] ) ) {
			$lookupTableLinks["global_users_sup"] = array();
		}
		if( !isset( $lookupTableLinks["global_users_sup"]["interventor_interno.supb_idusrglobal_fk"] )) {
			$lookupTableLinks["global_users_sup"]["interventor_interno.supb_idusrglobal_fk"] = array();
		}
		$lookupTableLinks["global_users_sup"]["interventor_interno.supb_idusrglobal_fk"]["edit"] = array("table" => "interventor_interno", "field" => "supb_idusrglobal_fk", "page" => "edit");
		if( !isset( $lookupTableLinks["contrato"] ) ) {
			$lookupTableLinks["contrato"] = array();
		}
		...
		if( !isset( $lookupTableLinks["q_info_compromisos"] ) ) {
			$lookupTableLinks["q_info_compromisos"] = array();
		}
		if( !isset( $lookupTableLinks["q_info_compromisos"]["contrato_rp.cid_fk"] )) {
			$lookupTableLinks["q_info_compromisos"]["contrato_rp.cid_fk"] = array();
		}
		$lookupTableLinks["q_info_compromisos"]["contrato_rp.cid_fk"]["edit"] = array("table" => "contrato_rp", "field" => "cid_fk", "page" => "edit");
		if( !isset( $lookupTableLinks["contrato"] ) ) {
			$lookupTableLinks["contrato"] = array();
		}
		...
		if( !isset( $lookupTableLinks["q_001_dashboard"]["informe_intersup_plan_pagos.id_cont_fk"] )) {
			$lookupTableLinks["q_001_dashboard"]["informe_intersup_plan_pagos.id_cont_fk"] = array();
		}
		$lookupTableLinks["q_001_dashboard"]["informe_intersup_plan_pagos.id_cont_fk"]["edit"] = array("table" => "informe_intersup_plan_pagos", "field" => "id_cont_fk", "page" => "edit");
		...
		if( !isset( $lookupTableLinks["cargo"]["informe_intersup.supa_cargo_id"] )) {
			$lookupTableLinks["cargo"]["informe_intersup.supa_cargo_id"] = array();
		}
		$lookupTableLinks["cargo"]["informe_intersup.supa_cargo_id"]["edit"] = array("table" => "informe_intersup", "field" => "supa_cargo_id", "page" => "edit");
		if( !isset( $lookupTableLinks["dependencia"] ) ) {
			$lookupTableLinks["dependencia"] = array();
		}
		if( !isset( $lookupTableLinks["dependencia"]["informe_intersup.supa_dependencia_id"] )) {
			$lookupTableLinks["dependencia"]["informe_intersup.supa_dependencia_id"] = array();
		}
		$lookupTableLinks["dependencia"]["informe_intersup.supa_dependencia_id"]["edit"] = array("table" => "informe_intersup", "field" => "supa_dependencia_id", "page" => "edit");
		if( !isset( $lookupTableLinks["cargo"] ) ) {
			$lookupTableLinks["cargo"] = array();
		}
		if( !isset( $lookupTableLinks["cargo"]["informe_intersup.supb_cargo_id"] )) {
			$lookupTableLinks["cargo"]["informe_intersup.supb_cargo_id"] = array();
		}
		$lookupTableLinks["cargo"]["informe_intersup.supb_cargo_id"]["edit"] = array("table" => "informe_intersup", "field" => "supb_cargo_id", "page" => "edit");
		if( !isset( $lookupTableLinks["dependencia"] ) ) {
			$lookupTableLinks["dependencia"] = array();
		}
		if( !isset( $lookupTableLinks["dependencia"]["informe_intersup.supb_dependencia_id"] )) {
			$lookupTableLinks["dependencia"]["informe_intersup.supb_dependencia_id"] = array();
		}
		$lookupTableLinks["dependencia"]["informe_intersup.supb_dependencia_id"]["edit"] = array("table" => "informe_intersup", "field" => "supb_dependencia_id", "page" => "edit");
		if( !isset( $lookupTableLinks["contractor_master"] ) ) {
			$lookupTableLinks["contractor_master"] = array();
		}
		...
		if( !isset( $lookupTableLinks["global_users"]["q_ctrl_entrega_acta_liquidacion_002.Username"] )) {
			$lookupTableLinks["global_users"]["q_ctrl_entrega_acta_liquidacion_002.Username"] = array();
		}
		$lookupTableLinks["global_users"]["q_ctrl_entrega_acta_liquidacion_002.Username"]["edit"] = array("table" => "q_ctrl_entrega_acta_liquidacion_002", "field" => "Username", "page" => "edit");
		if( !isset( $lookupTableLinks["tipo_docidentidad"] ) ) {
			$lookupTableLinks["tipo_docidentidad"] = array();
		}
		if( !isset( $lookupTableLinks["tipo_docidentidad"]["contractor_master_q.contractor_type"] )) {
			$lookupTableLinks["tipo_docidentidad"]["contractor_master_q.contractor_type"] = array();
		}
		$lookupTableLinks["tipo_docidentidad"]["contractor_master_q.contractor_type"]["edit"] = array("table" => "contractor_master_q", "field" => "contractor_type", "page" => "edit");
		if( !isset( $lookupTableLinks["q_divipola"] ) ) {
			$lookupTableLinks["q_divipola"] = array();
		}
		if( !isset( $lookupTableLinks["q_divipola"]["contractor_master_q.contractor_city"] )) {
			$lookupTableLinks["q_divipola"]["contractor_master_q.contractor_city"] = array();
		}
		$lookupTableLinks["q_divipola"]["contractor_master_q.contractor_city"]["edit"] = array("table" => "contractor_master_q", "field" => "contractor_city", "page" => "edit");
		if( !isset( $lookupTableLinks["tipo_banco"] ) ) {
			$lookupTableLinks["tipo_banco"] = array();
		}
		if( !isset( $lookupTableLinks["tipo_banco"]["contractor_master_q.bank_name"] )) {
			$lookupTableLinks["tipo_banco"]["contractor_master_q.bank_name"] = array();
		}
		$lookupTableLinks["tipo_banco"]["contractor_master_q.bank_name"]["edit"] = array("table" => "contractor_master_q", "field" => "bank_name", "page" => "edit");
		if( !isset( $lookupTableLinks["tipo_cta_banco"] ) ) {
			$lookupTableLinks["tipo_cta_banco"] = array();
		}
		if( !isset( $lookupTableLinks["tipo_cta_banco"]["contractor_master_q.bank_cta_type"] )) {
			$lookupTableLinks["tipo_cta_banco"]["contractor_master_q.bank_cta_type"] = array();
		}
		$lookupTableLinks["tipo_cta_banco"]["contractor_master_q.bank_cta_type"]["edit"] = array("table" => "contractor_master_q", "field" => "bank_cta_type", "page" => "edit");
		if( !isset( $lookupTableLinks["global_status"] ) ) {
			$lookupTableLinks["global_status"] = array();
		}
		if( !isset( $lookupTableLinks["global_status"]["contractor_master_q.active"] )) {
			$lookupTableLinks["global_status"]["contractor_master_q.active"] = array();
		}
		$lookupTableLinks["global_status"]["contractor_master_q.active"]["edit"] = array("table" => "contractor_master_q", "field" => "active", "page" => "edit");
		if( !isset( $lookupTableLinks["tparam_tipo_ct_regimen_tribut"] ) ) {
			$lookupTableLinks["tparam_tipo_ct_regimen_tribut"] = array();
		}
		if( !isset( $lookupTableLinks["tparam_tipo_ct_regimen_tribut"]["contractor_master_q.iva_regimen"] )) {
			$lookupTableLinks["tparam_tipo_ct_regimen_tribut"]["contractor_master_q.iva_regimen"] = array();
		}
		$lookupTableLinks["tparam_tipo_ct_regimen_tribut"]["contractor_master_q.iva_regimen"]["edit"] = array("table" => "contractor_master_q", "field" => "iva_regimen", "page" => "edit");
		if( !isset( $lookupTableLinks["q_001_dashboard"] ) ) {
			$lookupTableLinks["q_001_dashboard"] = array();
		}
		if( !isset( $lookupTableLinks["q_001_dashboard"]["contrato_planilla_liq.id_cont_fk"] )) {
			$lookupTableLinks["q_001_dashboard"]["contrato_planilla_liq.id_cont_fk"] = array();
		}
		$lookupTableLinks["q_001_dashboard"]["contrato_planilla_liq.id_cont_fk"]["edit"] = array("table" => "contrato_planilla_liq", "field" => "id_cont_fk", "page" => "edit");
		if( !isset( $lookupTableLinks["tparam_administradora"] ) ) {
			$lookupTableLinks["tparam_administradora"] = array();
		}
		if( !isset( $lookupTableLinks["tparam_administradora"]["contrato_planilla_liq.tipo_administradora"] )) {
			$lookupTableLinks["tparam_administradora"]["contrato_planilla_liq.tipo_administradora"] = array();
		}
		$lookupTableLinks["tparam_administradora"]["contrato_planilla_liq.tipo_administradora"]["edit"] = array("table" => "contrato_planilla_liq", "field" => "tipo_administradora", "page" => "edit");
		if( !isset( $lookupTableLinks["tparam_administradora_spa"] ) ) {
			$lookupTableLinks["tparam_administradora_spa"] = array();
		}
		if( !isset( $lookupTableLinks["tparam_administradora_spa"]["contrato_planilla_liq.tipo_subsistema"] )) {
			$lookupTableLinks["tparam_administradora_spa"]["contrato_planilla_liq.tipo_subsistema"] = array();
		}
		$lookupTableLinks["tparam_administradora_spa"]["contrato_planilla_liq.tipo_subsistema"]["edit"] = array("table" => "contrato_planilla_liq", "field" => "tipo_subsistema", "page" => "edit");
		if( !isset( $lookupTableLinks["tparam_administradora"] ) ) {
			$lookupTableLinks["tparam_administradora"] = array();
		}
