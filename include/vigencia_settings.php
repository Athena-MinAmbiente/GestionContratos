...
$tdatavigencia[".pagesByType"] = my_json_decode( "{\"export\":[\"export\"],\"list\":[\"list\"],\"view\":[\"view\"]}" );
$tdatavigencia[".originalPagesByType"] = $tdatavigencia[".pagesByType"];
$tdatavigencia[".pages"] = types2pages( my_json_decode( "{\"export\":[\"export\"],\"list\":[\"list\"],\"view\":[\"view\"]}" ) );
$tdatavigencia[".originalPages"] = $tdatavigencia[".pages"];
$tdatavigencia[".defaultPages"] = my_json_decode( "{\"export\":\"export\",\"list\":\"list\",\"view\":\"view\"}" );
...
$tdatavigencia[".badgeColor"] = "2F4F4F";
