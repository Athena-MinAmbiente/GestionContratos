...
$tdatanomina_cont_meses[".pagesByType"] = my_json_decode( "{\"search\":[\"search\"]}" );
$tdatanomina_cont_meses[".originalPagesByType"] = $tdatanomina_cont_meses[".pagesByType"];
$tdatanomina_cont_meses[".pages"] = types2pages( my_json_decode( "{\"search\":[\"search\"]}" ) );
$tdatanomina_cont_meses[".originalPages"] = $tdatanomina_cont_meses[".pages"];
$tdatanomina_cont_meses[".defaultPages"] = my_json_decode( "{\"search\":\"search\"}" );
...
$tdatanomina_cont_meses[".badgeColor"] = "B22222";
...
$tdatanomina_cont_meses[".sqlHead"] = "SELECT mes_id,  	mes_name,  	mes_dias,  	mes_concepto,  	mes_ctrl";
...
$proto0["m_strFieldList"] = "mes_id,  	mes_name,  	mes_dias,  	mes_concepto,  	mes_ctrl";
