...
$tdatainterventor_periodos[".badgeColor"] = "6B8E23";
...
//	contrato_audit
	...
	$detailsTablesData["interventor_periodos"][$dIndex] = $detailsParam;

	
		$detailsTablesData["interventor_periodos"][$dIndex]["masterKeys"] = array();

	$detailsTablesData["interventor_periodos"][$dIndex]["masterKeys"][]="id_periodo";

				$detailsTablesData["interventor_periodos"][$dIndex]["detailKeys"] = array();

	$detailsTablesData["interventor_periodos"][$dIndex]["detailKeys"][]="cont_periodicidad";
//endif
