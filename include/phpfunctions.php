...
{
	$value = "";
				if($table=="contrato_attached" && $field=="att_file")
	{
		;
		return $value;
	}
				if($table=="informe_intersup_oe" && $field=="evidencia")
	{
		...
		return $value;
				...
				if($table=="informe_intersup_oe" && $field=="evidencia_sup")
	{
		;
		return $value;
	}
				if($table=="informe_intersup_anexos_supervisor" && $field=="anexo_file")
	{
		;
		return $value;
	}
				if($table=="informe_intersup_anexos_supervisor" && $field=="anexo_file_sup")
	{
		;
		return $value;
	}
				if($table=="informe_intersup_oe_borrar" && $field=="actividad")
	{
		;
		return $value;
	}
				if($table=="informe_intersup_oe_borrar" && $field=="evidencia")
	{
		;
		return $value;
	}
				if($table=="informe_intersup_oe_supervisor" && $field=="evidencia_sup")
	{
		;
		return $value;
	}
				if($table=="informe_intersup_oe_supervisor" && $field=="evidencia")
	{
		;
		return $value;
	}
				if($table=="informe_intersup_oe_adm" && $field=="evidencia")
	{
		;
		return $value;
	}
				if($table=="informe_intersup_anexos_adm" && $field=="anexo_file")
	{
		;
		return $value;
	}
				if($table=="informe_intersup_anexos_adm" && $field=="anexo_file_sup")
	{
		;
		return $value;
	}
				if($table=="q_consulta_op" && $field=="op")
	{
		;
		return $value;
	}
				if($table=="contrato_attached_ov" && $field=="att_file")
	{
		;
		return $value;
	}
...
function GetLWWhere($field, $ptype, $table = "")
{
	...
	if(!$table)
		$table = $strTableName;
		if($table=="polizas_master" && $field=="id_att_fk")
	{
		$strWhere = " att_type = 1";
		return $strWhere;
	}
		...
		if($table=="informe_intersup3" && $field=="inf_estado")
	{
		...
		if($table=="informe_intersup4" && $field=="inf_consecutivo" && $ptype=="add")
	{
		$strWhere = " inf_st = 0 ";
		return $strWhere;
	}
		if($table=="informe_intersup4" && $field=="inf_consecutivo" && $ptype=="search")
	{
		$strWhere = " inf_st = 0 ";
		return $strWhere;
	}
		if($table=="informe_intersup4" && $field=="inf_estado")
	{
		$strWhere = " estadoi_id = 4 ";
		return $strWhere;
	}
		if($table=="informe_intersup2" && $field=="inf_consecutivo" && $ptype=="add")
	{
		$strWhere = " inf_st = 0 ";
		return $strWhere;
	}
		if($table=="informe_intersup2" && $field=="inf_consecutivo" && $ptype=="search")
	{
		$strWhere = " inf_st = 0 ";
		return $strWhere;
	}
		if($table=="informe_intersup2" && $field=="inf_estado" && $ptype=="edit")
	{
		$strWhere = " group_st = 1 ";
		return $strWhere;
	}
		if($table=="informe_intersup2" && $field=="inf_estado" && $ptype=="add")
	{
		$strWhere = " estadoi_id = 1";
		return $strWhere;
	}
		if($table=="informe_intersup2r" && $field=="inf_consecutivo" && $ptype=="add")
	{
		$strWhere = " inf_st = 0 ";
		return $strWhere;
	}
		if($table=="informe_intersup2r" && $field=="inf_consecutivo" && $ptype=="search")
	{
		$strWhere = " inf_st = 0 ";
		return $strWhere;
	}
		if($table=="informe_intersup2r" && $field=="inf_estado" && $ptype=="add")
	{
		$strWhere = " estadoi_id = 1";
		return $strWhere;
	}
		if($table=="informe_intersup_adm" && $field=="inf_consecutivo" && $ptype=="add")
	{
		$strWhere = " inf_st = 0 ";
		return $strWhere;
	}
		if($table=="informe_intersup_adm" && $field=="inf_consecutivo" && $ptype=="search")
	{
		$strWhere = " inf_st = 0 ";
		return $strWhere;
	}
		if($table=="informe_intersup_plan_pagos_adm" && $field=="inf_st" && $ptype=="edit")
	{
		$strWhere = " st_id = 0";
		return $strWhere;
	}
		if($table=="informe_intersup_plan_pagos_adm" && $field=="inf_st" && $ptype=="add")
	{
		$strWhere = " st_id = 0";
		return $strWhere;
	}
		if($table=="informe_intersup_plan_pagos_adm" && $field=="inf_st" && $ptype=="search")
	{
		$strWhere = " st_id = 0";
		return $strWhere;
	}
...
function GetDefaultValue($field, $ptype, $table="")
{
	...
	if(!$table)
		$table=$strTableName;
				if($table=="contrato" && $field=="cont_ano")
	{
		return strftime("%Y");
	}
				if($table=="contrato" && $field=="cont_estado")
	{
		return 2;
	}
				if($table=="contrato" && $field=="cont_tipo")
	{
		return 1;
	}
				if($table=="contrato" && $field=="cont_fechasistema")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="contrato" && $field=="cont_auditoria")
	{
		return 2;
	}
				if($table=="contrato_attached" && $field=="sys_user")
	{
		return $_SESSION["UserID"];
	}
				if($table=="contrato_attached" && $field=="sys_time")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="polizas_master" && $field=="sys_user")
	{
		return $_SESSION["UserID"];
	}
				if($table=="polizas_master" && $field=="sys_time")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				...
				if($table=="interventor_interno" && $field=="sys_date")
	{
		return strftime("%Y-%m-%d");
				...
				if($table=="interventor_interno" && $field=="sys_user")
	{
		return $_SESSION["UserID"];
	}
				if($table=="interventor_interno" && $field=="sup_status" && $ptype=="add")
	{
		return 1;
	}
				if($table=="interventor_interno" && $field=="sup_status" && $ptype=="search")
	{
		return 1;
	}
				...
				if($table=="informe_intersup_plan_pagos" && $field=="inf_st" && $ptype=="search")
	{
		return 0;
				...
				if($table=="informe_intersup_plan_pagos" && $field=="sysuser")
	{
		return $_SESSION["UserID"];
	}
				...
				if($table=="informe_intersup" && $field=="inf_estado" && $ptype=="edit")
	{
		return 3;
				...
				if($table=="informe_intersup" && $field=="inf_estado" && $ptype=="add")
	{
		return 1;
	}
				...
				if($table=="informe_intersup3" && $field=="sign_file")
	{
		return 2;
				...
				if($table=="informe_intersup3" && $field=="sign_verificacert_ip")
	{
		return $_SERVER["REMOTE_ADDR"];
	}
				if($table=="informe_intersup3" && $field=="sign_verificacert_user")
	{
		return $_SESSION["UserID"];
	}
				if($table=="informe_intersup3" && $field=="sign_verificacert_date")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="informe_intersup4" && $field=="inf_hash" && $ptype=="edit")
	{
		return $letra = (chr(rand(ord("A"), ord("Z")))).mt_rand(10000000,99999999); ;
	}
				if($table=="informe_intersup4" && $field=="inf_hash" && $ptype=="add")
	{
		return $letra = (chr(rand(ord("A"), ord("Z")))).mt_rand(10000000,99999999); ;
	}
				if($table=="informe_intersup4" && $field=="inf_hash" && $ptype=="search")
	{
		return $letra = (chr(rand(ord("A"), ord("Z")))).mt_rand(10000000,99999999); ;
	}
				if($table=="informe_intersup4" && $field=="inf_estado")
	{
		return 4;
				...
				if($table=="informe_intersup4" && $field=="inf_anio")
	{
		return strftime("%Y");
	}
				if($table=="informe_intersup4" && $field=="sign_date" && $ptype=="edit")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="informe_intersup4" && $field=="sign_date" && $ptype=="search")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="informe_intersup4" && $field=="sign_mailnot" && $ptype=="edit")
	{
		return $_SESSION["UMAIL"];
	}
				if($table=="informe_intersup4" && $field=="sign_mailnot" && $ptype=="search")
	{
		return $_SESSION["UMAIL"];
	}
				if($table=="informe_intersup4" && $field=="sign_file")
	{
		return 2;
	}
				if($table=="informe_intersup4" && $field=="sign_verificacert_ip")
	{
		return $_SERVER["REMOTE_ADDR"];
	}
				if($table=="informe_intersup4" && $field=="sign_verificacert_user")
	{
		return $_SESSION["UserID"];
	}
				if($table=="informe_intersup4" && $field=="sign_verificacert_date")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="informe_intersup_oe_borrar" && $field=="sup_fecha")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="informe_intersup_oe_borrar" && $field=="sys_user")
	{
		return $_SESSION["UserID"];
	}
				if($table=="informe_intersup_oe_supervisor" && $field=="sup_fecha")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="informe_intersup_oe_supervisor" && $field=="sys_user")
	{
		return $_SESSION["UserID"];
	}
				if($table=="informe_intersup2" && $field=="inf_hash" && $ptype=="edit")
	{
		return $letra = (chr(rand(ord("A"), ord("Z")))).mt_rand(10000000,99999999); ;
	}
				if($table=="informe_intersup2" && $field=="inf_hash" && $ptype=="add")
	{
		return $letra = (chr(rand(ord("A"), ord("Z")))).mt_rand(10000000,99999999); ;
	}
				if($table=="informe_intersup2" && $field=="inf_hash" && $ptype=="search")
	{
		return $letra = (chr(rand(ord("A"), ord("Z")))).mt_rand(10000000,99999999); ;
	}
				if($table=="informe_intersup2" && $field=="inf_estado" && $ptype=="add")
	{
		return 1;
				...
				if($table=="informe_intersup2" && $field=="inf_estado" && $ptype=="search")
	{
		return 3;
	}
				if($table=="informe_intersup2" && $field=="inf_fechapresenta")
	{
		return strftime("%Y-%m-%d");
	}
				if($table=="informe_intersup2" && $field=="sign_date" && $ptype=="edit")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="informe_intersup2" && $field=="sign_date" && $ptype=="search")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="informe_intersup2" && $field=="sign_mailnot" && $ptype=="edit")
	{
		return $_SESSION["UMAIL"];
	}
				if($table=="informe_intersup2" && $field=="sign_mailnot" && $ptype=="search")
	{
		return $_SESSION["UMAIL"];
	}
				if($table=="informe_intersup2" && $field=="sign_file")
	{
		return 1;
	}
				if($table=="informe_intersup2r" && $field=="inf_hash" && $ptype=="edit")
	{
		return $letra = (chr(rand(ord("A"), ord("Z")))).mt_rand(10000000,99999999); ;
	}
				if($table=="informe_intersup2r" && $field=="inf_hash" && $ptype=="add")
	{
		return $letra = (chr(rand(ord("A"), ord("Z")))).mt_rand(10000000,99999999); ;
	}
				if($table=="informe_intersup2r" && $field=="inf_hash" && $ptype=="search")
	{
		return $letra = (chr(rand(ord("A"), ord("Z")))).mt_rand(10000000,99999999); ;
	}
				if($table=="informe_intersup2r" && $field=="inf_estado" && $ptype=="edit")
	{
		return 3;
	}
				if($table=="informe_intersup2r" && $field=="inf_estado" && $ptype=="add")
	{
		return 1;
				...
				if($table=="informe_intersup2r" && $field=="inf_estado" && $ptype=="search")
	{
		return 3;
	}
				if($table=="informe_intersup2r" && $field=="inf_fechapresenta")
	{
		return strftime("%Y-%m-%d");
	}
				if($table=="informe_intersup2r" && $field=="sign_date" && $ptype=="edit")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="informe_intersup2r" && $field=="sign_date" && $ptype=="search")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="informe_intersup2r" && $field=="sign_mailnot" && $ptype=="edit")
	{
		return $_SESSION["UMAIL"];
	}
				if($table=="informe_intersup2r" && $field=="sign_mailnot" && $ptype=="search")
	{
		return $_SESSION["UMAIL"];
	}
				if($table=="informe_intersup2r" && $field=="sign_file")
	{
		return 1;
	}
				if($table=="informe_intersup_adm" && $field=="sign_date" && $ptype=="edit")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="informe_intersup_adm" && $field=="sign_date" && $ptype=="search")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="informe_intersup_adm" && $field=="sign_mailnot" && $ptype=="edit")
	{
		return $_SESSION["UMAIL"];
	}
				if($table=="informe_intersup_adm" && $field=="sign_mailnot" && $ptype=="search")
	{
		return $_SESSION["UMAIL"];
	}
				if($table=="informe_intersup_adm" && $field=="sign_file")
	{
		return 2;
	}
				if($table=="informe_intersup_adm" && $field=="sign_verificacert_ip")
	{
		return $_SERVER["REMOTE_ADDR"];
	}
				if($table=="informe_intersup_adm" && $field=="sign_verificacert_user")
	{
		return $_SESSION["UserID"];
	}
				if($table=="informe_intersup_adm" && $field=="sign_verificacert_date")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="informe_intersup_oe_adm" && $field=="sup_fecha")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="informe_intersup_oe_adm" && $field=="sys_user")
	{
		return $_SESSION["UserID"];
	}
				if($table=="informe_intersup_plan_pagos_adm" && $field=="inf_st" && $ptype=="edit")
				...
				if($table=="informe_intersup_plan_pagos_adm" && $field=="inf_st" && $ptype=="search")
	{
		return 0;
				...
				if($table=="contrato_ov" && $field=="cont_estado")
	{
		return 2;
	}
				if($table=="contrato_ov" && $field=="cont_tipo")
	{
		return 1;
	}
				if($table=="contrato_ov" && $field=="cont_fechasistema")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="contrato_attached_ov" && $field=="sys_user")
	{
		return $_SESSION["UserID"];
	}
				if($table=="contrato_attached_ov" && $field=="sys_time")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="contrato_audit" && $field=="cont_ano")
	{
		return strftime("%Y");
	}
				if($table=="contrato_audit" && $field=="cont_estado")
	{
		return 2;
	}
				if($table=="contrato_audit" && $field=="pre_contnumero")
	{
		return GC;
	}
				if($table=="contrato_audit" && $field=="cont_tipo")
	{
		return 1;
	}
				if($table=="contrato_audit" && $field=="cont_fechasistema")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="contrato_audit" && $field=="cont_auditoria")
	{
		return 2;
	}
				if($table=="contrato_modifica_suspension" && $field=="mod_tipo")
	{
		return 4;
	}
				if($table=="contrato_modifica_suspension" && $field=="sys_user")
	{
		return $_SESSION["UserID"];
	}
	return "";
...
;
				...
				if($table=="informe_intersup2" && $field=="inf_estado" && $ptype=="search")
	{
		return 3;
				...
				if($table=="informe_intersup2" && $field=="sign_hash" && $ptype=="edit")
	{
		return sprintf('%04X%04X-%04X-%04X-%04X-%04X%04X%04X', mt_rand(0, 65535), mt_rand(0, 65535), mt_rand(0, 65535), mt_rand(16384, 20479), mt_rand(32768, 49151), mt_rand(0, 65535), mt_rand(0, 65535), mt_rand(0, 65535));
;
	}
				...
				if($table=="informe_intersup2r" && $field=="inf_estado" && $ptype=="search")
	{
		return 3;
				...
				if($table=="informe_intersup2r" && $field=="sign_hash" && $ptype=="edit")
	{
		return sprintf('%04X%04X-%04X-%04X-%04X-%04X%04X%04X', mt_rand(0, 65535), mt_rand(0, 65535), mt_rand(0, 65535), mt_rand(16384, 20479), mt_rand(32768, 49151), mt_rand(0, 65535), mt_rand(0, 65535), mt_rand(0, 65535));
;
	}
...
function GetUploadFolderExpression($field, $file, $table )
{
	if($table=="informe_intersup_anexos_supervisor" && $field=="anexo_file")
	{
		"http://gestion.mincit.gov.co/Athena/GestionContratistas/anexos/".$file["anexo_file"];
;
		return $folder;
	}
	if($table=="informe_intersup_oe_borrar" && $field=="actividad")
	{
		$folder = "http://gestion.mincit.gov.co/Athena/GestionContratistas/anexos_oe/";
;
		return $folder;
	}
	if($table=="informe_intersup_oe_supervisor" && $field=="evidencia_sup")
	{
		$folder = "../GesDoc/Contratos/".$_SESSION["ContID"]."/informes/".$_SESSION["InfID"]."/evidencias";
;
		return $folder;
	}
	if($table=="informe_intersup_oe_supervisor" && $field=="evidencia")
