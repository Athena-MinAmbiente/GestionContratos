...
//$tdataq_consulta_op[".listAjax"] = false;
	...
	$tdataq_consulta_op[".audit"] = true;

	$tdataq_consulta_op[".locking"] = true;
...
$tdataq_consulta_op[".badgeColor"] = "9acd32";
...
//	Custom field settings
	...
	$fdata["FullName"] = "op";
				...
				$fdata["UploadFolder"] = "../GestionFinanciera/";
...
$masterTablesData["q_consulta_op"] = array();
	...
	$masterTablesData["q_consulta_op"][1]["masterKeys"][]="id_cont_fk";
				$masterTablesData["q_consulta_op"][1]["detailKeys"] = array();
	$masterTablesData["q_consulta_op"][1]["detailKeys"][]="id_cont_fk";
