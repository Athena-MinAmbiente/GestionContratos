...
$correobcc = $_SESSION['EmailBCC'];

$email=$values['inf_mail_a'].",".$values['inf_mail_b'];
$from=$_SESSION['correosmtp'];
$fromName=$_SESSION['GModulo']." | INFORMES SUPERVISIÓN ";
$msg = '<p><img src="http://athenaqa.mincit.gov.co/_img/logos/logo_30050.png" alt="Logo"></p>';
$msg .= '<p>Se ha habilitado un nuevo informe para su gestión con el código de verificación: ' . $values['inf_hash'] . '. Por favor, revisa tu bandeja de entrada en el módulo de contratistas.</p></br>';
$subject="Nuevo informe de supervisión :: Código de informe: ".$values['inf_hash'];

$msg.= "</br>Número de informe: ".$values['inf_consecutivo']."</br>";
//$msg.= "Periodo: ".$values['inf_fecharep_i']." al ".$values['inf_fecharep_f']."</br>";
//$msg.= "Asunto: ".$values['hr_asunto']."\r\n";
//$msg.= "</br>Para atender este requerimiento ingrese a: ".$_SESSION['GURLHOME'].""."</br>";
$msg .= "</br>Para atender este requerimiento, ingrese a: <a href='" . $_SESSION['GURLHOME'] . "'>" . $_SESSION['GURLHOME'] . "</a></br>";

//$msg.= "Age: ".$values["age"]."\r\n";

$ret=runner_mail(array('to' => $email, 'bcc' => $correobcc, 'subject' => $subject, 'htmlbody' => $msg, 'fromName'=> $fromName, 'from'=>$from));
if(!$ret["mailed"])
	echo $ret["message"];
