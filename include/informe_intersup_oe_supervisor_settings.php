...
if(mlang_getcurrentlang()=="Spanish")
{
	...
	$fieldLabelsinforme_intersup_oe_supervisor["Spanish"]["id_cont_fk"] = "Número interno";
	...
	$fieldLabelsinforme_intersup_oe_supervisor["Spanish"]["sup_obs"] = "Motivo de devolución";
	...
	$fieldLabelsinforme_intersup_oe_supervisor["Spanish"]["evidencia"] = "Evidencia";
	$fieldToolTipsinforme_intersup_oe_supervisor["Spanish"]["evidencia"] = "";
	$placeHoldersinforme_intersup_oe_supervisor["Spanish"]["evidencia"] = "";
...
$tdatainforme_intersup_oe_supervisor[".addPageEvents"] = true;
...
$tdatainforme_intersup_oe_supervisor[".googleLikeFields"][] = "evidencia";
...
$tdatainforme_intersup_oe_supervisor[".sqlHead"] = "SELECT isoe_id,  inf_id_fk,  oe_id_fk,  id_cont_fk,  cont_nit_contra_ta_fk,  oe_ordinal,  oe,  actividad,  evidencia_sup,  sup_aprueba,  sup_fecha,  sup_obs,  sys_last_upd,  sys_user,  evidencia";
...
// Begin Lookup settings
	...
	$edata["DisplayField"] = "sn_oe";
				...
				$edata["LookupWhere"] = "sn_id IN (2,3)";
...
//	Custom field settings
	...
	$fdata["ownerTable"] = "informe_intersup_oe";
	$fdata["Label"] = GetFieldLabel("informe_intersup_oe_supervisor","evidencia");
	$fdata["FieldType"] = 201;
...
//end of Filters settings
	...
	$tdatainforme_intersup_oe_supervisor["evidencia"] = $fdata;
		$tdatainforme_intersup_oe_supervisor[".searchableFields"][] = "evidencia";
...
$proto0["m_strFieldList"] = "isoe_id,  inf_id_fk,  oe_id_fk,  id_cont_fk,  cont_nit_contra_ta_fk,  oe_ordinal,  oe,  actividad,  evidencia_sup,  sup_aprueba,  sup_fecha,  sup_obs,  sys_last_upd,  sys_user,  evidencia";
...
$proto37["m_srcTableName"] = "informe_intersup_oe_supervisor";
...
$proto36["m_alias"] = "";
$proto36["m_srcTableName"] = "informe_intersup_oe_supervisor";
$proto38=array();
$proto38["m_sql"] = "";
