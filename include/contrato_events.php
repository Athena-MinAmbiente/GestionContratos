...
$sql = DB::prepareSQL("UPDATE contrato
INNER JOIN q_contrato_paa ON contrato.id_cont = q_contrato_paa.id_cont_fk 
SET contrato.cont_paa_id = q_contrato_paa.paa_id_fk;");
DB::Exec( $sql );
