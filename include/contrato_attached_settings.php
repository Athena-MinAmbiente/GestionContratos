...
$tdatacontrato_attached[".pagesByType"] = my_json_decode( "{\"add\":[\"add\"],\"edit\":[\"edit\"],\"export\":[\"export\"],\"list\":[\"list\"],\"masterlist\":[\"masterlist\"],\"masterprint\":[\"masterprint\"],\"print\":[\"print\"],\"search\":[\"search\"],\"view\":[\"view\"]}" );
$tdatacontrato_attached[".originalPagesByType"] = $tdatacontrato_attached[".pagesByType"];
$tdatacontrato_attached[".pages"] = types2pages( my_json_decode( "{\"add\":[\"add\"],\"edit\":[\"edit\"],\"export\":[\"export\"],\"list\":[\"list\"],\"masterlist\":[\"masterlist\"],\"masterprint\":[\"masterprint\"],\"print\":[\"print\"],\"search\":[\"search\"],\"view\":[\"view\"]}" ) );
$tdatacontrato_attached[".originalPages"] = $tdatacontrato_attached[".pages"];
$tdatacontrato_attached[".defaultPages"] = my_json_decode( "{\"add\":\"add\",\"edit\":\"edit\",\"export\":\"export\",\"list\":\"list\",\"masterlist\":\"masterlist\",\"masterprint\":\"masterprint\",\"print\":\"print\",\"search\":\"search\",\"view\":\"view\"}" );
...
if(mlang_getcurrentlang()=="Spanish")
{
	...
	$fieldLabelscontrato_attached["Spanish"]["id_cont_fk"] = "Id";
	...
	$fieldToolTipscontrato_attached["Spanish"]["att_file"] = "Solo documentos PDF";
	$placeHolderscontrato_attached["Spanish"]["att_file"] = "";
	$fieldLabelscontrato_attached["Spanish"]["sys_user"] = "Usuario";
	...
	$fieldLabelscontrato_attached["Spanish"]["sys_time"] = "Fecha";
	...
	$fieldLabelscontrato_attached["Spanish"]["att_cod"] = "Cod";
	$fieldToolTipscontrato_attached["Spanish"]["att_cod"] = "";
	$placeHolderscontrato_attached["Spanish"]["att_cod"] = "";
	$fieldLabelscontrato_attached["Spanish"]["cont_pre"] = "Número contrato / vigencia";
...
//$tdatacontrato_attached[".listAjax"] = false;
	...
	$tdatacontrato_attached[".audit"] = true;

	$tdatacontrato_attached[".locking"] = true;
...
$tdatacontrato_attached[".badgeColor"] = "008000";
...
$tdatacontrato_attached[".sqlHead"] = "SELECT id_att,  	id_cont_fk,  	cont_pre,  	cont_num,  	cont_vigencia,  	att_type,  	nom_doc,  	att_cod,  	att_file,  	sys_user,  	sys_date,  	sys_time,  	sys_stat";
...
//	Custom field settings
	...
	$fdata["FullName"] = "att_file";
		...
		$fdata["CompatibilityMode"] = true;
				...
				$fdata["UploadFolder"] = "../GesDoc/Contratos/";
...
$masterTablesData["contrato_attached"] = array();
	...
	$masterParams["type"] = PAGE_LIST;
					$masterTablesData["contrato_attached"][1] = $masterParams;
				$masterTablesData["contrato_attached"][1]["masterKeys"] = array();
	$masterTablesData["contrato_attached"][1]["masterKeys"][]="id_cont";
				$masterTablesData["contrato_attached"][1]["detailKeys"] = array();
	$masterTablesData["contrato_attached"][1]["detailKeys"][]="id_cont_fk";
	...
	$masterParams["type"] = PAGE_LIST;
					$masterTablesData["contrato_attached"][2] = $masterParams;
				$masterTablesData["contrato_attached"][2]["masterKeys"] = array();
	$masterTablesData["contrato_attached"][2]["masterKeys"][]="id_cont_fk";
				$masterTablesData["contrato_attached"][2]["detailKeys"] = array();
	$masterTablesData["contrato_attached"][2]["detailKeys"][]="id_cont_fk";
	...
	$masterParams["type"] = PAGE_LIST;
					$masterTablesData["contrato_attached"][3] = $masterParams;
				$masterTablesData["contrato_attached"][3]["masterKeys"] = array();
	$masterTablesData["contrato_attached"][3]["masterKeys"][]="id_cont";
				$masterTablesData["contrato_attached"][3]["detailKeys"] = array();
	$masterTablesData["contrato_attached"][3]["detailKeys"][]="id_cont_fk";
...
$tdatacontrato_attached[".hasEvents"] = true;
