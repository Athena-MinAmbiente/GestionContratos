...
//				$this->strLabel = $params['name'];
	...
	protected function isProjectDB()
	{
		...
		if("tparam_tipo_ct_002" == $this->chrt_array['tables'][0])
			return true;
		if("tipo_contrato" == $this->chrt_array['tables'][0])
			return true;
		if("contrato_forma_pago" == $this->chrt_array['tables'][0])
			return true;
		if("tipo_si_no" == $this->chrt_array['tables'][0])
			return true;
		if("contrato_estados" == $this->chrt_array['tables'][0])
			return true;
		if("contrato_pre" == $this->chrt_array['tables'][0])
			return true;
		if("contrato_attached" == $this->chrt_array['tables'][0])
			return true;
		if("contrato_attached_type" == $this->chrt_array['tables'][0])
			return true;
		if("polizas_master" == $this->chrt_array['tables'][0])
			return true;
		if("polizas_tipo" == $this->chrt_array['tables'][0])
			return true;
		if("polizas_aseguradoras" == $this->chrt_array['tables'][0])
			return true;
		if("info_secop" == $this->chrt_array['tables'][0])
			return true;
		if("interventor_interno" == $this->chrt_array['tables'][0])
			return true;
		if("tparam_habilita" == $this->chrt_array['tables'][0])
			return true;
		if("contrato_cdp" == $this->chrt_array['tables'][0])
			return true;
		if("dependencia" == $this->chrt_array['tables'][0])
			return true;
		if("contrato_rp" == $this->chrt_array['tables'][0])
			return true;
		...
		if("informe_intersup" == $this->chrt_array['tables'][0])
			return true;
		if("nomina_cont_meses" == $this->chrt_array['tables'][0])
			return true;
		...
		if("informe_intersup" == $this->chrt_array['tables'][0])
			return true;
		if("q_gestion_infosup_pagos" == $this->chrt_array['tables'][0])
			return true;
		if("informe_intersup" == $this->chrt_array['tables'][0])
			return true;
		if("informe_intersup_cxc" == $this->chrt_array['tables'][0])
			return true;
		if("informe_intersup_oe" == $this->chrt_array['tables'][0])
			return true;
		if("informe_intersup_anexos" == $this->chrt_array['tables'][0])
		...
		if("informe_intersup_plan_pagos" == $this->chrt_array['tables'][0])
			return true;
		if("q_consulta_op" == $this->chrt_array['tables'][0])
			return true;
		if("q_global_supervisores_activos_group" == $this->chrt_array['tables'][0])
			return true;
		if("q_bandejaentrada_supervisores" == $this->chrt_array['tables'][0])
			return true;
		if("contrato" == $this->chrt_array['tables'][0])
		...
		if("contrato_attached" == $this->chrt_array['tables'][0])
			return true;
		if("q_s_ctrl_pagado_001" == $this->chrt_array['tables'][0])
			return true;
		if("q_s_ctrl_pagado_001" == $this->chrt_array['tables'][0])
			return true;
		if("contrato" == $this->chrt_array['tables'][0])
			return true;
		if("contrato_paa" == $this->chrt_array['tables'][0])
			return true;
		if("q_informe_secop_publicados_dbgpaa" == $this->chrt_array['tables'][0])
			return true;
		if("global_duracion" == $this->chrt_array['tables'][0])
			return true;
		if("contrato_modifica" == $this->chrt_array['tables'][0])
			return true;
		if("tparam_tipopago" == $this->chrt_array['tables'][0])
			return true;
		if("q_001_dashboard" == $this->chrt_array['tables'][0])
			return true;
		if("002_producto" == $this->chrt_array['tables'][0])
			return true;
		if("005_catalogo" == $this->chrt_array['tables'][0])
			return true;
		if("gestioncontratos_ugrights" == $this->chrt_array['tables'][0])
			return true;
		if("gestioncontratos_ugmembers" == $this->chrt_array['tables'][0])
			return true;
		if("global_users" == $this->chrt_array['tables'][0])
			return true;
		if("q_info_compromisos" == $this->chrt_array['tables'][0])
			return true;
		if("q_ctrl_entregainformes_004" == $this->chrt_array['tables'][0])
			return true;
		if("send_mail_supervisores" == $this->chrt_array['tables'][0])
			return true;
		if("q_ctrl_entrega_acta_liquidacion_001" == $this->chrt_array['tables'][0])
			return true;
		if("q_ctrl_entrega_acta_liquidacion_002" == $this->chrt_array['tables'][0])
			return true;
		if("q_ctrl_entrega_acta_liquidacion_001" == $this->chrt_array['tables'][0])
			return true;
		if("tparam_numsup" == $this->chrt_array['tables'][0])
			return true;
		...
		if("contractor_master" == $this->chrt_array['tables'][0])
			return true;
		if("contrato_planilla_liq" == $this->chrt_array['tables'][0])
			return true;
		if("tparam_administradora" == $this->chrt_array['tables'][0])
			return true;
		if("tparam_administradora_spa" == $this->chrt_array['tables'][0])
			return true;
		return false;
	}
