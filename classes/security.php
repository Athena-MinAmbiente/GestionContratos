...
class Security
{
	...
	public static function getUserGroups()
	{
		...
		$sql = "select ". $grConnection->addFieldWrappers( "Label" )
			." from ". $grConnection->addTableWrappers( "gestioncontratos_uggroups" ) . " WHERE " . $grConnection->addFieldWrappers( "GroupID" )
	...
	*  For AD it is <provider code><username>
	...
	public static function getUgMembersDatasource() {
		...
		global $cman;
		return getDbTableDataSource( "gestioncontratos_ugmembers", $cman->getUserGroupsConnId() );
	}
	...
	public static function getUgGroupsDatasource() {
		...
		global $cman;
		return getDbTableDataSource( "gestioncontratos_uggroups", $cman->getUserGroupsConnId() );
	}
	...
	public static function getUgRightsDatasource() {
		...
		global $cman;
		return getDbTableDataSource( "gestioncontratos_ugrights", $cman->getUserGroupsConnId() );
	}
	...
	public static function  fillTablesOwnerId( $data, $provider ) {
		...
		if( $securityType == stAD && !$provider["useDbGroups"] ) {
			...
			storageSet( "_q_bandejaentrada_supervisores_OwnerID", $userId );
						storageSet( "_q_bandejaentrada_supervisores1_OwnerID", $userId );
						storageSet( "_q_bandejaentrada_supervisores3_OwnerID", $userId );
						storageSet( "_informe_intersup3_OwnerID", $userId );
						storageSet( "_informe_intersup4_OwnerID", $userId );
						storageSet( "_informe_intersup2_OwnerID", $userId );
						storageSet( "_informe_intersup2r_OwnerID", $userId );
						storageSet( "_q_s_ctrl_pagado_001_OwnerID", $userId );
						storageSet( "_q_s_ctrl_pagado_001 Report_OwnerID", $userId );
		} else {
						storageSet( "OwnerID", $data["idusrglobal"] );
			storageSet( "_q_bandejaentrada_supervisores_OwnerID", $data["idusrglobal"] );
						storageSet( "_q_bandejaentrada_supervisores1_OwnerID", $data["idusrglobal"] );
						storageSet( "_q_bandejaentrada_supervisores3_OwnerID", $data["idusrglobal"] );
						storageSet( "_informe_intersup3_OwnerID", $data["usr_personalid"] );
						storageSet( "_informe_intersup4_OwnerID", $data["usr_personalid"] );
						storageSet( "_informe_intersup2_OwnerID", $data["usr_personalid"] );
						storageSet( "_informe_intersup2r_OwnerID", $data["usr_personalid"] );
						storageSet( "_q_s_ctrl_pagado_001_OwnerID", $data["usr_email"] );
						storageSet( "_q_s_ctrl_pagado_001 Report_OwnerID", $data["usr_email"] );
		}
	}
