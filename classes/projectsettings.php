...
function fillProjectEntites()
{
	...
	$projectEntities[ "contractor_master_vinc" ] = array( "url" => "contractor_master_vinc", "type" => 1 );
	$projectEntitiesReverse[ "contractor_master_vinc" ] = "contractor_master_vinc";
	...
	$projectEntities[ "tipo_contrato" ] = array( "url" => "tipo_contrato", "type" => 0 );
	$projectEntitiesReverse[ "tipo_contrato" ] = "tipo_contrato";
	...
	$projectEntities[ "tipo_si_no" ] = array( "url" => "tipo_si_no", "type" => 0 );
	$projectEntitiesReverse[ "tipo_si_no" ] = "tipo_si_no";
	...
	$projectEntities[ "polizas_master" ] = array( "url" => "polizas_master", "type" => 0 );
	$projectEntitiesReverse[ "polizas_master" ] = "polizas_master";
	...
	$projectEntities[ "info_secop" ] = array( "url" => "info_secop", "type" => 0 );
	$projectEntitiesReverse[ "info_secop" ] = "info_secop";
	...
	$projectEntities[ "tparam_habilita" ] = array( "url" => "tparam_habilita", "type" => 0 );
	$projectEntitiesReverse[ "tparam_habilita" ] = "tparam_habilita";
	$projectEntities[ "contrato_cdp" ] = array( "url" => "contrato_cdp", "type" => 0 );
	$projectEntitiesReverse[ "contrato_cdp" ] = "contrato_cdp";
	$projectEntities[ "dependencia" ] = array( "url" => "dependencia", "type" => 0 );
	$projectEntitiesReverse[ "dependencia" ] = "dependencia";
	$projectEntities[ "contrato_rp" ] = array( "url" => "contrato_rp", "type" => 0 );
	...
	$projectEntities[ "informe_intersup4" ] = array( "url" => "informe_intersup4", "type" => 1 );
	$projectEntitiesReverse[ "informe_intersup4" ] = "informe_intersup4";
	...
	$projectEntities[ "informe_intersup_anexos_supervisor" ] = array( "url" => "informe_intersup_anexos_supervisor", "type" => 1 );
	$projectEntitiesReverse[ "informe_intersup_anexos_supervisor" ] = "informe_intersup_anexos_supervisor";
	$projectEntities[ "informe_intersup_oe_borrar" ] = array( "url" => "informe_intersup_oe_borrar", "type" => 1 );
	$projectEntitiesReverse[ "informe_intersup_oe_borrar" ] = "informe_intersup_oe_borrar";
	$projectEntities[ "informe_intersup_oe_supervisor" ] = array( "url" => "informe_intersup_oe_supervisor", "type" => 1 );
	$projectEntitiesReverse[ "informe_intersup_oe_supervisor" ] = "informe_intersup_oe_supervisor";
	$projectEntities[ "informe_intersup2" ] = array( "url" => "informe_intersup2", "type" => 1 );
	$projectEntitiesReverse[ "informe_intersup2" ] = "informe_intersup2";
	$projectEntities[ "informe_intersup2r" ] = array( "url" => "informe_intersup2r", "type" => 1 );
	$projectEntitiesReverse[ "informe_intersup2r" ] = "informe_intersup2r";
	$projectEntities[ "q_gestion_infosup_pagos" ] = array( "url" => "q_gestion_infosup_pagos", "type" => 0 );
	$projectEntitiesReverse[ "q_gestion_infosup_pagos" ] = "q_gestion_infosup_pagos";
	$projectEntities[ "informe_intersup_adm" ] = array( "url" => "informe_intersup_adm", "type" => 1 );
	$projectEntitiesReverse[ "informe_intersup_adm" ] = "informe_intersup_adm";
	$projectEntities[ "informe_intersup_cxc_adm" ] = array( "url" => "informe_intersup_cxc_adm", "type" => 1 );
	$projectEntitiesReverse[ "informe_intersup_cxc_adm" ] = "informe_intersup_cxc_adm";
	$projectEntities[ "informe_intersup_oe_adm" ] = array( "url" => "informe_intersup_oe_adm", "type" => 1 );
	$projectEntitiesReverse[ "informe_intersup_oe_adm" ] = "informe_intersup_oe_adm";
	$projectEntities[ "informe_intersup_anexos_adm" ] = array( "url" => "informe_intersup_anexos_adm", "type" => 1 );
	$projectEntitiesReverse[ "informe_intersup_anexos_adm" ] = "informe_intersup_anexos_adm";
	$projectEntities[ "informe_intersup_plan_pagos_adm" ] = array( "url" => "informe_intersup_plan_pagos_adm", "type" => 1 );
	$projectEntitiesReverse[ "informe_intersup_plan_pagos_adm" ] = "informe_intersup_plan_pagos_adm";
	$projectEntities[ "q_consulta_op" ] = array( "url" => "q_consulta_op", "type" => 0 );
	$projectEntitiesReverse[ "q_consulta_op" ] = "q_consulta_op";
	$projectEntities[ "q_global_supervisores_activos_group" ] = array( "url" => "q_global_supervisores_activos_group", "type" => 0 );
	$projectEntitiesReverse[ "q_global_supervisores_activos_group" ] = "q_global_supervisores_activos_group";
	$projectEntities[ "q_bandejaentrada_supervisores_consulta" ] = array( "url" => "q_bandejaentrada_supervisores_consulta", "type" => 1 );
	$projectEntitiesReverse[ "q_bandejaentrada_supervisores_consulta" ] = "q_bandejaentrada_supervisores_consulta";
	$projectEntities[ "contrato_ov" ] = array( "url" => "contrato_ov", "type" => 1 );
	$projectEntitiesReverse[ "contrato_ov" ] = "contrato_ov";
	$projectEntities[ "contrato_attached_ov" ] = array( "url" => "contrato_attached_ov", "type" => 1 );
	$projectEntitiesReverse[ "contrato_attached_ov" ] = "contrato_attached_ov";
	$projectEntities[ "q_s_ctrl_pagado_001" ] = array( "url" => "q_s_ctrl_pagado_001", "type" => 0 );
	$projectEntitiesReverse[ "q_s_ctrl_pagado_001" ] = "q_s_ctrl_pagado_001";
	$projectEntities[ "q_s_ctrl_pagado_001 Report" ] = array( "url" => "q_s_ctrl_pagado_001_report", "type" => 2 );
	$projectEntitiesReverse[ "q_s_ctrl_pagado_001_report" ] = "q_s_ctrl_pagado_001 Report";
	$projectEntities[ "contrato_audit" ] = array( "url" => "contrato_audit", "type" => 1 );
	$projectEntitiesReverse[ "contrato_audit" ] = "contrato_audit";
	$projectEntities[ "contrato_paa" ] = array( "url" => "contrato_paa", "type" => 0 );
	$projectEntitiesReverse[ "contrato_paa" ] = "contrato_paa";
	$projectEntities[ "q_informe_secop_publicados_dbgpaa" ] = array( "url" => "q_informe_secop_publicados_dbgpaa", "type" => 0 );
	$projectEntitiesReverse[ "q_informe_secop_publicados_dbgpaa" ] = "q_informe_secop_publicados_dbgpaa";
	$projectEntities[ "global_duracion" ] = array( "url" => "global_duracion", "type" => 0 );
	$projectEntitiesReverse[ "global_duracion" ] = "global_duracion";
	$projectEntities[ "contrato_modifica_suspension" ] = array( "url" => "contrato_modifica_suspension", "type" => 1 );
	$projectEntitiesReverse[ "contrato_modifica_suspension" ] = "contrato_modifica_suspension";
	$projectEntities[ "tparam_tipopago" ] = array( "url" => "tparam_tipopago", "type" => 0 );
	$projectEntitiesReverse[ "tparam_tipopago" ] = "tparam_tipopago";
	$projectEntities[ "q_001_dashboard_master" ] = array( "url" => "q_001_dashboard_master", "type" => 1 );
	$projectEntitiesReverse[ "q_001_dashboard_master" ] = "q_001_dashboard_master";
	$projectEntities[ "consulta_producto" ] = array( "url" => "consulta_producto", "type" => 1 );
	$projectEntitiesReverse[ "consulta_producto" ] = "consulta_producto";
	$projectEntities[ "consulta_catalogo" ] = array( "url" => "consulta_catalogo", "type" => 1 );
	$projectEntitiesReverse[ "consulta_catalogo" ] = "consulta_catalogo";
	...
	$projectEntities[ "q_info_compromisos" ] = array( "url" => "q_info_compromisos", "type" => 0 );
	$projectEntitiesReverse[ "q_info_compromisos" ] = "q_info_compromisos";
	$projectEntities[ "q_ctrl_entregainformes_004" ] = array( "url" => "q_ctrl_entregainformes_004", "type" => 0 );
	$projectEntitiesReverse[ "q_ctrl_entregainformes_004" ] = "q_ctrl_entregainformes_004";
	$projectEntities[ "send_mail_supervisores" ] = array( "url" => "send_mail_supervisores", "type" => 0 );
	$projectEntitiesReverse[ "send_mail_supervisores" ] = "send_mail_supervisores";
	$projectEntities[ "send_mail_actaliq" ] = array( "url" => "send_mail_actaliq", "type" => 1 );
	$projectEntitiesReverse[ "send_mail_actaliq" ] = "send_mail_actaliq";
	$projectEntities[ "q_ctrl_entrega_acta_liquidacion_002" ] = array( "url" => "q_ctrl_entrega_acta_liquidacion_002", "type" => 0 );
	$projectEntitiesReverse[ "q_ctrl_entrega_acta_liquidacion_002" ] = "q_ctrl_entrega_acta_liquidacion_002";
	$projectEntities[ "q_ctrl_entrega_acta_liquidacion_001" ] = array( "url" => "q_ctrl_entrega_acta_liquidacion_001", "type" => 0 );
	$projectEntitiesReverse[ "q_ctrl_entrega_acta_liquidacion_001" ] = "q_ctrl_entrega_acta_liquidacion_001";
	$projectEntities[ "tparam_numsup" ] = array( "url" => "tparam_numsup", "type" => 0 );
	$projectEntitiesReverse[ "tparam_numsup" ] = "tparam_numsup";
	...
	$projectEntities[ "contractor_master_q" ] = array( "url" => "contractor_master_q", "type" => 1 );
	$projectEntitiesReverse[ "contractor_master_q" ] = "contractor_master_q";
	$projectEntities[ "contrato_planilla_liq" ] = array( "url" => "contrato_planilla_liq", "type" => 0 );
	$projectEntitiesReverse[ "contrato_planilla_liq" ] = "contrato_planilla_liq";
	$projectEntities[ "tparam_administradora" ] = array( "url" => "tparam_administradora", "type" => 0 );
	$projectEntitiesReverse[ "tparam_administradora" ] = "tparam_administradora";
	$projectEntities[ "tparam_administradora_spa" ] = array( "url" => "tparam_administradora_spa", "type" => 0 );
	$projectEntitiesReverse[ "tparam_administradora_spa" ] = "tparam_administradora_spa";
}
